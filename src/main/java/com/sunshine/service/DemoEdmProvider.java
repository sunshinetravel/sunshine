...
public class DemoEdmProvider extends CsdlAbstractEdmProvider {
  ...
  // Service Namespace
  public static final String NAMESPACE = "OData.Sunshine";
  ...
  public CsdlEntityType getEntityType(FullQualifiedName entityTypeName) {
    ...
    if (entityTypeName.equals(ET_PRODUCT_FQN)) {
      ...
      entityType.setNavigationProperties(navPropList);
        ...
        CsdlProperty id = new CsdlProperty().setName("ID")
            .setType(EdmPrimitiveTypeKind.Int32.getFullQualifiedName());
        CsdlProperty customerid = new CsdlProperty().setName("Customerid")
            .setType(EdmPrimitiveTypeKind.Int32.getFullQualifiedName());
        CsdlProperty orderdate = new CsdlProperty().setName("Orderdate")
                .setType(EdmPrimitiveTypeKind.String.getFullQualifiedName());
        CsdlProperty number = new CsdlProperty().setName("Number")
                .setType(EdmPrimitiveTypeKind.Int32.getFullQualifiedName());
        CsdlProperty location = new CsdlProperty().setName("Location")
                .setType(EdmPrimitiveTypeKind.String.getFullQualifiedName());
        CsdlProperty date_from = new CsdlProperty().setName("Date_from")
                .setType(EdmPrimitiveTypeKind.String.getFullQualifiedName());
        CsdlProperty date_to = new CsdlProperty().setName("Date_to")
                .setType(EdmPrimitiveTypeKind.String.getFullQualifiedName());
        CsdlProperty remark = new CsdlProperty().setName("Remark")
                .setType(EdmPrimitiveTypeKind.String.getFullQualifiedName());
        ...
        entityType.setProperties(Arrays.asList(id, customerid,orderdate,number,location,date_from,date_to,remark));
        entityType.setKey(Arrays.asList(propertyRef));
      }
